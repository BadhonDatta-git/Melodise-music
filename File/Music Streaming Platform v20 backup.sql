...
(1, 'Taylor Swiftyy', 'demo@gmail.com', '1234', 'Male', '1999-01-12', 'American singer-songwriter known for narrative songwriting.', 'USA', '1'),
...
(8, 'Shadhin', 'shadhin@gmail.com', '1234', '2002-03-27', 'Male', 'Bangladesh', '8.jpg'),
...
--
ALTER TABLE `songs`
  MODIFY `SongID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `subscription_records`
--
ALTER TABLE `subscription_records`
  MODIFY `SubscriptionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112219;
